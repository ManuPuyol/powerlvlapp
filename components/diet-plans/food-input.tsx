...
import { FOOD_LIBRARY, type FoodTemplate } from '@/lib/food-library'
import { cn } from '@/lib/utils'

type FoodInputProps = {
  value: string
  onChange: (value: string, suggestion?: FoodTemplate) => void
  className?: string
}

export function FoodInput({ value, onChange, className }: FoodInputProps) {
